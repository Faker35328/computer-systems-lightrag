...
def parse_args() -> argparse.Namespace:
    ...
    args.chunking_strategy = get_env_value("CHUNKING_STRATEGY", "token", str).lower()
    if args.chunking_strategy not in {"token", "recursive_character"}:
        raise ValueError(
            "CHUNKING_STRATEGY must be either 'token' or 'recursive_character'"
        )
