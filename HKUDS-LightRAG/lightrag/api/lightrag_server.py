...
def create_app(args):
    ...
    chunking_func = {
        "token": chunking_by_token_size,
        "recursive_character": chunking_by_recursive_character,
    }[args.chunking_strategy]
    logger.info(
        "Text chunking strategy: %s (chunk_size=%s, chunk_overlap_size=%s)",
        args.chunking_strategy,
        args.chunk_size,
        args.chunk_overlap_size,
    )
